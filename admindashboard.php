...
<div class="ui pointing fixed menu">
    <div class="ui container">
        ...
        <a href="index.php" class="item">FurniCare</a>
        ...
        <div class="panel">
            ...
            while ($row = mysqli_fetch_assoc($results1))
            {
                ...
                <tr>
                    ...
                    <td><a href="products/editCategory.php?id=<?php echo $row["id"]?>">Edit</a></td>
        ...
        <table border="1" class="ui table">
            ...
            while ($row1 = mysqli_fetch_assoc($results2))
            {
                ...
                <tr>
                    ...
                    <td><a href="products/editProduct.php?id=<?php echo $row1["id"]?>">Edit</a></td>
